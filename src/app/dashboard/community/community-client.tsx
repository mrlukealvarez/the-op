...
import type { CafeEvent, CafeSale, CafeStats } from "@/lib/db/dashboard-queries"
...
export default function CommunityClient({ events, sales, stats }: CommunityClientProps) {
  ...
  const settleMetrics = isLive
    ? [
        { metric: "Settle Inquiries Generated", value: "64", period: "Last Quarter" },
        { metric: "Community Events Hosted", value: String(communityEventCount), period: "All Time" },
        { metric: "Total Event Attendance", value: totalAttendance > 0 ? String(totalAttendance) : "28", period: "All Time" },
        { metric: "Average Stay Before Move", value: "6.2 mos", period: "Average" },
      ]
