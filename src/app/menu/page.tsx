...
const categories = [
  {
    ...
    items: [
      ...
      {
        name: "Latte",
        description: "Classic or flavored — vanilla, lavender, honey",
        price: "$6 - $7",
      },
      {
        name: "Cold Brew",
        description: "24-hour steep, smooth and bold",
        price: "$5 - $6",
      },
      {
        name: "Pour Over",
      ...
      {
        name: "Chai Latte",
        description: "House-spiced with local honey",
        price: "$6",
      },
      {
        name: "Hot Chocolate",
        description: "Belgian chocolate, house whip",
        price: "$5",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "Coca-Cola + coconut cream + lime — 24oz/32oz",
        price: "$4 - $5",
      },
      {
        name: "Premium Dirty Soda",
        description: "Dr Pepper + vanilla cream + raspberry — 24oz/32oz",
        price: "$5 - $6",
      },
      {
        name: "Tropical Refresher",
        description: "Sprite + passion fruit + coconut",
        price: "$5",
      },
      {
        name: "Dirty Dr Pepper",
        description: "Dr Pepper + coconut cream + lime",
        price: "$4 - $5",
      },
      {
        name: "Berry Blast",
        description: "Sprite + mixed berry + cream",
        price: "$5",
      },
      {
        name: "Kids Soda",
        description: "Pick your flavor, pick your cream — 12oz",
        price: "$2.50",
      },
    ],
  },
  {
    ...
    description:
      "Rotating taps from Black Hills breweries — never the same twice",
    items: [
      {
        name: "Lost Cabin IPA",
        description: "Hill City, SD — rotating seasonal",
        price: "$7.50",
      },
      {
        name: "Sawyer Brewing Lager",
        description: "Black Hills craft, crisp finish",
        price: "$7.50",
      },
      {
        name: "Black Hills Cider",
        description: "Local orchard, rotating variety",
        price: "$7",
      },
      {
        name: "Seasonal Tap",
        description: "Ask your barista — changes weekly",
        price: "$7.50 - $9",
      },
      {
        name: "Flight of 4",
        description: "Sample four local pours",
        price: "$12",
      },
      {
        name: "Kombucha",
        description: "House-brewed, rotating flavors",
        price: "$6",
      },
    ],
  },
    ...
    items: [
      {
        ...
        description: "House butter, local honey or jam",
        price: "$5",
      },
      {
        name: "Avocado Toast",
        description: "Sourdough, everything seasoning, microgreens",
        price: "$9",
      },
      {
        name: "Breakfast Burrito",
        description: "Scrambled eggs, cheese, green chile",
        price: "$10",
      },
      {
        name: "Croissant",
        description: "Plain, almond, or chocolate",
        price: "$4 - $5",
      },
      {
        name: "Muffins",
        description: "Blueberry, banana walnut, rotating special",
        price: "$4",
      },
      {
        name: "Energy Bites",
        description: "Oat, peanut butter, chia seed",
        price: "$3",
      },
      {
        name: "Soup of the Day",
        description: "Seasonal, made in-house",
        price: "$7",
      },
      {
        name: "Grilled Cheese",
  ...
  },
  {
    ...
    items: [
      {
        name: "THE OP Mug",
        description: "Ceramic, 12oz, espresso brown glaze",
        price: "$18",
      },
      {
        name: "THE OP T-Shirt",
        description: "Soft cotton, unisex, 5 colorways",
        price: "$28",
      },
      {
        name: "THE OP Hoodie",
        description: "Heavyweight, embroidered logo",
        price: "$55",
      },
      {
        name: "Whole Bean Coffee",
        description: "12oz bag, rotating roast",
        price: "$16",
      },
      {
        name: "Sticker Pack",
      ...
      {
        name: "THE OP Cap",
        description: "Structured snapback, leather patch",
        price: "$32",
      },
    ],
  },
          ...
          <ScaleReveal>
            <div className="mt-16 rounded-2xl border border-amber/20 bg-amber/5 p-8 text-center">
              ...
              <p className="mt-2 text-sm text-warm-gray">
                The only cafe in Custer open past 6pm. Coffee, craft beer, dirty
                sodas, and good company — morning to night.
              </p>
            </div>
          </ScaleReveal>
        </div>
